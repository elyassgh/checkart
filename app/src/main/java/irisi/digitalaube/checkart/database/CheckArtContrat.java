...
public class CheckArtContrat {
    ...
    public static class CarpetTable implements BaseColumns {
        public static final String TABLE_NAME = "Tapis";
        ...
        public static final String COLUMN_NAME_TAPIS_W1 = "w1";
        public static final String COLUMN_NAME_TAPIS_W2 = "w2";
        public static final String COLUMN_NAME_TAPIS_W3 = "w3";
